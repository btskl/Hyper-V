...
do{
    ...
    switch ($overzicht) {
        'A' {
            ...
            & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_1\Subswitch_1-A\Switch-1A.ps1
        }

        'B'{
            Write-Host "U heeft optie B gekozen"
            & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_1\Subswitch_1-B\Switch-1B.ps1
        }

        'C'{
            Write-Host "U heeft optie C gekozen"
            & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_1\Subswitch_1-C\Switch_1C.ps1
        }
