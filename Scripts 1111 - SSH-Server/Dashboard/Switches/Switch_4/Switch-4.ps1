...
$project = Read-host "Kies optie"
    switch($project){
        'A'
        {
        & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_4\Subswitch-4-A\Switch-4A.ps1
        }

        'B' #date and time
        {
        & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_4\Subswitch-4-B\Switch-4B.ps1
        }

        'C'
        {
        & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_4\Subswitch-4-C\Switch-4C.ps1
        }
