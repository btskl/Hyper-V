        ...
        'A'
            {
                ...
                Switch ($quickstart) {
                    '1'
                    {
                        & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_2\Subswitch_2-A\Switch-2A1.ps1
                    }

                    '2'
                    {
                        & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_2\Subswitch_2-A\Switch-2A2.ps1
                    }
                }
            }
        'B'    
            {
                ...
                Switch ($custom) {
                    '1' {
                        ...
                        & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_2\Subswitch_2-B\Switch-2B1.ps1
                    }

                    '2' {
                        Write-Host "U heeft gekozen voor W10_LTSC"
                        & C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Switches\Switch_2\Subswitch_2-B\Switch-2B2.ps1
                    }
                }
            }
    'Q'
