...
do{
    ...
    Switch($Hoofdmenu) {
        ...
        # Get-VM
        '1' { 
        & C:\Users\Administrator\Desktop\Scripts\Dashboard\Switches\Switch_1\Switch-1.ps1
        }

        # Maak VM
        '2' { 
        & C:\Users\Administrator\Desktop\Scripts\Dashboard\Switches\Switch_2\Switch-2.ps1
        }
        
        # Power-settings VM
        '3' { 
        & C:\Users\Administrator\Desktop\Scripts\Dashboard\Switches\Switch_3\Switch-3.ps1
        }

        # Project-instellingen
        '4' { 
        & C:\Users\Administrator\Desktop\Scripts\Dashboard\Switches\Switch_4\Switch-4.ps1
        }
