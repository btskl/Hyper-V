...
function Show_Menu2A{
    ...
    Write-Host "3: Druk op '3' voor Linux"
    Write-Host "Q: Druk op 'Q' voor de hoofdmenu"
}
        ...
        'A'
            {
                ...
                Switch ($quickstart) {
                    ...
                    '3' {
                        Write-Host "U heeft gekozen voor Linux"
                        & C:\Users\Administrator\Desktop\Scripts\Dashboard\Switches\Switch_2\Subswitch_2-A\Switch-2A3.ps1
                    }
                }
            }
        'B'    
            {
                ...
                Switch ($custom) {
                    ...
                    '3' {
                        Write-Host "U heeft gekozen voor Linux"
                        & C:\Users\Administrator\Desktop\Scripts\Dashboard\Switches\Switch_2\Subswitch_2-B\Switch-2B3.ps1
                    }
                }
            }
    'Q'
