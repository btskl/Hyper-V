& C:\Users\Administrator.TEST\Desktop\Scripts\Dashboard\Remove_Project\Overzicht.ps1
...
try {
    ...
    Write-Host "✅ Groep '$($grp.Name)' verwijderd."
}
catch {
    Write-Host "❌ Fout bij verwijderen van groep '$($grp.Name)': $_"
}
