...
function Show_Menu1{
    Write-Host "==================================================" 
    Write-Host "A: Druk op 'A' voor Get-VM" # Haal overzicht op voor alle VM's
    Write-Host "B: Druk op 'B' voor Get-VMMemory met OS-versie" # Haal overzicht op voor alle VM's, incl. Host waarop het script draait
