...
function Show_Menu4C{ # hoofdmenu groep
    ...
    Write-Host "C: Druk op 'C' voor hernoemen groep [Rename-VMGroup] "
    Write-Host "D: Druk op 'D' voor aanpassen ledenstructuur"
    Write-Host "E: Druk op 'E' voor power-settings groepen"
    Write-Host "Q: Druk op 'Q' voor de hoofdmenu"
}
